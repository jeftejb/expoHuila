  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} `}>Hotelaria e Turismo</p>
        <h2 className={`${styles.sectionHeadText}`}>Conheca os principais pontos da nossa sidade</h2>
      </motion.div>
      ...
      <div className='mt-20 flex flex-wrap gap-7'>
        {pointer.map((project, index) =>   index < 6 &&(
...
export default SectionWrapper(Points, "")